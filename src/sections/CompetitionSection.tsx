          ...
          <div className="relative bg-beach-mint rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
            ...
            <div className="mb-6 sm:mb-8 md:mb-12 text-center">
              ...
              <p className="text-base sm:text-lg md:text-xl max-w-4xl mx-auto font-roboto font-bold leading-relaxed">
                Vi kommer till er arbetsplats och ger teamet en praktisk AI-boost med konkreta verktyg och beprövade metoder. Målet? Att ni ska vara AI-redo när hösten kommer. För idag handlar AI-implementering mer sällan om avancerad teknik – utan om att systematiskt våga testa, lära och anpassa. Vi kallar det "AI-beach prepp", medan en dyr managementkonsult skulle kalla det "avgörande konkurrensfördel". Nyfiken på vad det skulle betyda för er?
              </p>
            </div>
