          ...
          <div className="relative bg-beach-mint rounded-3xl p-12">
            ...
            <div className="mb-12 text-center">
              <h2 className="text-[3.4375em] font-outfit font-extrabold leading-tight mb-8">
                AI-FOMO PÅ JOBBET?! VI HJÄLPER ER ATT KOMMA I AI-FROM INNAN SOMMAREN!
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="border-2 border-dashed border-gray-400 rounded-lg p-6 text-center">
                <h3 className="font-special-elite text-[1.125em] mb-4">Anmäl ditt företag</h3>
                <p>Berätta varför ni vill bli AI-fit - vi vill höra er story.</p>
              </div>
              
              <div className="border-2 border-dashed border-gray-400 rounded-lg p-6 text-center">
                <h3 className="font-special-elite text-[1.125em] mb-4">En vinnare varje vecka</h3>
                <p>Juryn väljer ett företag i veckan fram till vecka 27.</p>
              </div>
              
              <div className="border-2 border-dashed border-gray-400 rounded-lg p-6 text-center">
                <h3 className="font-special-elite text-[1.125em] mb-4">Vi kommer till er!</h3>
