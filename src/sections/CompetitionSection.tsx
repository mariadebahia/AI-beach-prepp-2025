        ...
        <AnimatedSection animation="fade-down">
          <div className="relative bg-beach-mint rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8">
            ...
            <div className="mb-6 sm:mb-8 md:mb-12 text-center">
              <h2 className="text-[1.875em] sm:text-[2.5em] md:text-[3.125em] font-outfit font-extrabold leading-tight mb-4 sm:mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6 sm:mb-8">
              <div className="border-2 border-dashed border-gray-400 rounded-lg p-4 text-center">
                ...
                <p className="text-sm">Berätta varför ni vill bli AI-fit - vi vill höra er story.</p>
              </div>
              ...
              <div className="border-2 border-dashed border-gray-400 rounded-lg p-4 text-center">
                ...
                <p className="text-sm">Juryn väljer ett företag i veckan fram till vecka 27.</p>
              </div>
              ...
              <div className="border-2 border-dashed border-gray-400 rounded-lg p-4 text-center">
                ...
                <p className="text-sm">Och kör en anpassad AI-workshop.</p>
              </div>
            </div>
