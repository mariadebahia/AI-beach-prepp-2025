            ...
            <AnimatedSection animation="fade-up" delay="300">
              <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-lg transition-shadow duration-300 hover:shadow-xl text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-10">
                  ...
                  <a
                    href={`mailto:?subject=${enc("// OMG, du kan aldrig gissa vad jobbet fick i ett AI-fitnesstest! - AIbeachprep.se //")}&body=${enc(`OMG! Jag har precis gjort ett AI-fitnesstest för jobbet och resultaten är faktiskt rätt intressanta! \
