      ...
      <div className="max-w-[700px] mx-auto">
        ...
        {!showResults ? (
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm text-center">
            ...
            <div className="quiz-body-html-content mb-8">
              <p className="quiz-body-text">{quizResults.description}</p>
              {quizResults.recommendations && quizResults.recommendations.length > 0 && (
                <>
                  <h6 className="text-[23px] font-medium mb-4 mt-6">Rekommendationer:</h6>
