...
const QuizSection: React.FC = () => {
  ...
  if (showResults && quizResults) {
    return (
      <section className="bg-[#482376] py-[20px] sm:py-[25px] md:py-[35px] px-4" id="quiz-section">
  ...
  return (
    <section className="bg-beach-purple py-[20px] sm:py-[25px] md:py-[35px] px-4" id="quiz-section">
